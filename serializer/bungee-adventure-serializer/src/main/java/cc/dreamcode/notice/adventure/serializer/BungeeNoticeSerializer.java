...
import cc.dreamcode.notice.adventure.BungeeNotice;
...
public class BungeeNoticeSerializer implements ObjectSerializer<BungeeNotice> {
  ...
  @Override
  public BungeeNotice deserialize(
      @NonNull DeserializationData data, @NonNull GenericsDeclaration generics) {

    BungeeNotice minecraftNotice =
        new BungeeNotice(data.get("type", NoticeType.class), data.get("text", String.class));
