...
public class PaperNoticeSerializer implements ObjectSerializer<PaperNotice> {
  ...
  @Override
  public PaperNotice deserialize(
      @NonNull DeserializationData data, @NonNull GenericsDeclaration generics) {

    PaperNotice minecraftNotice =
        new PaperNotice(data.get("type", NoticeType.class), data.get("text", String.class));
