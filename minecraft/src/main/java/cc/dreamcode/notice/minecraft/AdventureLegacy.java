...
public final class AdventureLegacy {
  ...
  private static final MiniMessage MINI_MESSAGE =
      MiniMessage.builder().postProcessor(new AdventureLegacyColor()).build();
  ...
  public static List<Component> splitDeserialize(
      @NonNull String rawText, TextReplacementConfig textReplacementConfig) {
  ...
  public static Component joiningDeserialize(
      @NonNull String rawText, TextReplacementConfig textReplacementConfig) {
  ...
  public static Component deserialize(
      @NonNull String text, TextReplacementConfig textReplacementConfig) {
